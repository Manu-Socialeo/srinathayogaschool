...
const sampleCourses = [
  { id: 'ashtanga', title: 'Ashtanga Yoga', type: 'Online Class', price: 150, currency: 'USD', depositPercent: 10, description: 'Traditional Mysore-style Ashtanga practice with personalized guidance.', startDate: '2026-04-15', endDate: '2026-06-15', seatsBooked: 12, seatLimit: 30, image: '/pixelperfectthemes.com/demos/themes/medit/wp-content/themes/medit/assets/img/image-01.jpg' },
  { id: 'hatha', title: 'Hatha Yoga', type: 'Online Class', price: 120, currency: 'USD', depositPercent: 10, description: 'Classical Hatha yoga with focus on alignment, breath control, and meditation.', startDate: '2026-04-20', endDate: '2026-07-20', seatsBooked: 8, seatLimit: 25, image: '/pixelperfectthemes.com/demos/themes/medit/wp-content/themes/medit/assets/img/image-02.jpg' },
  { id: 'iyengar', title: 'Iyengar Yoga', type: 'Online Workshop', price: 200, currency: 'USD', depositPercent: 10, description: 'Precision-based practice focusing on alignment and use of props.', startDate: '2026-05-01', endDate: '2026-05-03', seatsBooked: 5, seatLimit: 20, image: '/pixelperfectthemes.com/demos/themes/medit/wp-content/themes/medit/assets/img/image-03.jpg' },
  { id: 'vinyasa', title: 'Vinyasa Flow', type: 'Online Course', price: 180, currency: 'USD', depositPercent: 10, description: 'Dynamic flow yoga connecting breath with movement.', startDate: '2026-05-10', endDate: '2026-07-10', seatsBooked: 15, seatLimit: 35, image: '/pixelperfectthemes.com/demos/themes/medit/wp-content/themes/medit/assets/img/hero-01.jpg' },
];

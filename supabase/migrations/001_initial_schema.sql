-- Srinatha Yoga School - Initial Database Schema
-- Run this in Supabase SQL Editor

-- Reset: drop all tables in reverse dependency order for a clean slate
DROP TABLE IF EXISTS ttc_enrollments CASCADE;
...
DROP TABLE IF EXISTS ttc_resources CASCADE;
...
-- Policy added after enrollments table is created below
...
-- Lessons policy (enrollments must exist first)
...
-- 17. TTC Resources (file metadata)
